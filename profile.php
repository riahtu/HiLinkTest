						...
						<div class="contact-information-area">
							<div class="information-item">
								...
								<div class="bacik-information contact-information-item">
									...
									<ul>
										<li><label>School Name:</label><span><?php echo $school;?></span></li>
										<li><label>Grade:</label><span><?php echo $grade;?></span></li>
										<li><label>Birthday:</label><span><?php echo $birthday;?></span></li>
									</ul>
								</div>
							</div>
						</div>
